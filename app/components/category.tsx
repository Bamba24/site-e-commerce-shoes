  ...
  return (
    <div className="px-4 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-4 justify-center items-center">
        {/* Item 1 */}
        <div className="lg:row-span-2 h-60 sm:h-80 lg:h-[32rem] flex items-end gap-y-2 bg-slate-100 [background-image:url('/images/basketball-hommes/air-jordan-1.jpeg')] bg-cover bg-center bg-no-repeat rounded-xl">
          <p className="[font-size:var(--police-title-card-primary)] text-white ml-3 mb-3">Nike</p>
        </div>
        ...
        {/* Item 4 */}
        <div className="h-60 sm:h-72 flex items-end gap-y-2 bg-slate-100 [background-image:url('/images/Running-Hommes/runing-hommes-10.jpeg')] bg-cover bg-center bg-no-repeat hover rounded-xl">
          <p className="[font-size:var(--police-title-card-primary)] text-slate-900 ml-3 mb-3">Nike</p>
        </div>
      </div>
    </div>
  );
